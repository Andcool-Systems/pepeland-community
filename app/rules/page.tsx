    ...
    return (
        <main className={style.main}>
            <div className={style.container}>
                ...
                <p>Вы можете подать заявку на размещение здесь Вашего сайта, связанного с Пепелендом. Для этого необходимо написать в телеграм автору проекта: <TelegramUser username="Guevin1" link="https://t.me/guevin1" />, однако так-же необходимо, что-бы Ваш сайт соответствовал нижеперечисленным требованиям.</p>
