    ...
    return (
        <main className={style.main}>
            <div className={style.container}>
                ...
                <p>Вы можете подать заявку на размещение здесь Вашего сайта, связанного с Пепелендом. Для этого необходимо написать в телеграм автору проекта: <DiscordUser username="Guevin1" link="https://discordapp.com/users/440034971390836737/" />, однако так-же необходимо, чтобы Ваш сайт соответствовал нижеперечисленным требованиям.</p>
                ...
                <ol>
                    ...
                    <li>Если вы хотите открыто или нативно рекламировать что-либо на своём сайте - уточните это у <DiscordUser username="Guevin1" link="https://discordapp.com/users/440034971390836737/" /></li>
